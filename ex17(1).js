...
var pwm = 0;
var Kp = 2; // proportional factor
var Ki = 0.01; // integral factor
var Kd = 0.6; // differential factor
var pwm = 0;
var pwmLimit = 254;
...
function handler(req, res) {
    fs.readFile(__dirname + "/example17(1).html",
    function (err, data) {
        if (err) {
...
board.on("ready", function() {
    ...
    board.analogRead(0, function(value){
        desiredValue = value; // continuous read of analog pin 0controlAlgorithmStartedFlag == 0
    });
