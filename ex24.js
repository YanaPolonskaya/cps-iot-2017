...
board.pinMode(0, board.MODES.ANALOG); // enable analog
...
if (readAnalogPin0Flag == 1) desiredValue = value; //
...
setInterval(function(){controlAlgorithm(parameters);}, 30); // call the alg. on 30ms
